...
var bootState = {
  ...
  preload: function() {
    game.load.image('progressbar', 'egg/assets/images/progressbar.png');
    game.load.bitmapFont('engeexpa', 'egg/assets/fonts/engeexpa.png', 'egg/assets/fonts/engeexpa.fnt');
  },
...
var loadState = {
  preload: function() {
    ...
    game.load.bitmapFont('zerothre', 'egg/assets/fonts/zerothre.png', 'egg/assets/fonts/zerothre.fnt');
    game.load.bitmapFont('record', 'egg/assets/fonts/record.png', 'egg/assets/fonts/record.fnt');
    game.load.bitmapFont('instructions', 'egg/assets/fonts/instructions.png', 'egg/assets/fonts/instructions.fnt');

    game.load.image('title', 'egg/assets/images/title.png');
    game.load.image('walls', 'egg/assets/images/walls.png');
    game.load.image('grounds', 'egg/assets/images/grounds.png');
    game.load.image('summary', 'egg/assets/images/summary.png');
    game.load.image('menu', 'egg/assets/images/menu.png');
    game.load.image('cursor', 'egg/assets/images/cursor.png');
    game.load.image('hud', 'egg/assets/images/hud.png');
    game.load.image('arrowleft', 'egg/assets/images/arrow-left.png');
    game.load.image('arrowright', 'egg/assets/images/arrow-right.png');
    game.load.image('creativecommons', 'egg/assets/images/cc-by-nc-sa-88x31.png');

    game.load.spritesheet('hero', 'egg/assets/images/character.png', 32, 32);
    game.load.spritesheet('capsules', 'egg/assets/images/capsules.png', 32, 32);
    game.load.spritesheet('viruses', 'egg/assets/images/viruses.png', 32, 32);
    game.load.spritesheet('changers', 'egg/assets/images/changers.png', 32, 32);
    game.load.spritesheet('transformation', 'egg/assets/images/transformation.png', 32, 32);

    // SFX
    game.load.audio('capture', 'egg/assets/sounds/capture.mp3');
    game.load.audio('changer', 'egg/assets/sounds/changer.mp3');
    game.load.audio('walking', 'egg/assets/sounds/walking.mp3');
    game.load.audio('option', 'egg/assets/sounds/cursor.mp3');
    game.load.audio('select', 'egg/assets/sounds/select.mp3');
    game.load.audio('win', 'egg/assets/sounds/win.mp3');
    game.load.audio('blocked', 'egg/assets/sounds/blocked.mp3');

    // BGM
    game.load.audio('main', 'egg/assets/sounds/main.mp3', 0.75, true);
    game.load.audio('finish', 'egg/assets/sounds/finish.mp3', 0.75);
    game.load.audio('track1', 'egg/assets/sounds/track1.mp3', 0.75, true);
    game.load.audio('track2', 'egg/assets/sounds/track2.mp3', 0.75, true);
    game.load.audio('track3', 'egg/assets/sounds/track3.mp3', 0.75, true);
    game.load.audio('track4', 'egg/assets/sounds/track4.mp3', 0.75, true);
    game.load.audio('track5', 'egg/assets/sounds/track5.mp3', 0.75, true);
    game.load.audio('track6', 'egg/assets/sounds/track6.mp3', 0.75, true);

    for (var i=1; i<=game.global.totalLevels; i++) {
      game.load.tilemap(i.toString(), 'egg/assets/maps/' + i.toString() + '.json', null, Phaser.Tilemap.TILED_JSON);
    }
  },
